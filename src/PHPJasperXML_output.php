        ...
        if ($bandname == 'pageFooter' || $bandname == 'lastPageFooter') {
            foreach ($this->variables as $varname => $varsetting) {
                ...
                if ($varsetting['resetType'] === 'Page') {
                    $this->variables[$varname]['total_value'] =  ($bandname == 'lastPageFooter') ? $this->variables[$varname]['value'] : $this->variables[$varname]['lastvalue'];

                    if ('chiness_total' === $varname) {
                        $computevalue = ($bandname == 'lastPageFooter') ?  $this->variables[$varname]['value'] : $this->variables[$varname]['lastvalue'];
                        ...
                        if (($bandname == 'lastPageFooter'))
                            $this->variables[$varname]['value'] = $chiness_amount_string . $formattedAmount;
                    }
